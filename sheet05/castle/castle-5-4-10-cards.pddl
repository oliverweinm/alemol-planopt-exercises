(define (problem castle-5-4-10-cards)
(:domain beleaguered-castle)
; Pile 0: diamond4 spade3 heart2 heart5
; Pile 1: spade5 club3 club2 spade2
; Pile 2: heart3 club4 diamond5 club5
; Pile 3: heart4 diamond2 spade4 diamond3
(:objects
    pile0
    pile1
    pile2
