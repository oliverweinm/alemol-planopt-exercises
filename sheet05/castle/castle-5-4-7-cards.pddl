(define (problem castle-5-4-7-cards)
(:domain beleaguered-castle)
; Pile 0: diamond5 diamond2 club4 heart3
; Pile 1: club5 spade5 heart5 club3
; Pile 2: diamond4 club2 spade2 spade4
; Pile 3: heart2 diamond3 heart4 spade3
(:objects
    pile0
    pile1
    pile2
